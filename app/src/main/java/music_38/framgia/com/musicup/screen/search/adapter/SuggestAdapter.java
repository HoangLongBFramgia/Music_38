...
public class SuggestAdapter extends RecyclerView.Adapter<SuggestAdapter.SearchViewHolder> {
    ...
    private ArrayList<String> mSuggestKeys;
    private OnItemClickListener mOnItemClickListener;
    private LayoutInflater mLayoutInflater;

    public SuggestAdapter(ArrayList<String> suggestKeys, OnItemClickListener onItemClickListener) {
        mSuggestKeys = suggestKeys;
    ...
    public void onBindViewHolder(@NonNull SuggestAdapter.SearchViewHolder detailViewHolder, int i) {
        String suggestKey = mSuggestKeys.get(i);
        detailViewHolder.bindData(suggestKey);
    }

    @Override
    public int getItemCount() {
        return mSuggestKeys != null ? mSuggestKeys.size() : 0;
    }
