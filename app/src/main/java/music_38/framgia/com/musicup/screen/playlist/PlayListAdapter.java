...
public class PlayListAdapter extends RecyclerView.Adapter<PlayListAdapter.DetailViewHolder> {

    private List<Track> mTracks;
    private OnItemPlaylistClickListener mListener;
    private LayoutInflater mLayoutInflater;

    PlayListAdapter(List<Track> tracks, OnItemPlaylistClickListener listener) {
        mTracks = tracks;
        mListener = listener;
    }
